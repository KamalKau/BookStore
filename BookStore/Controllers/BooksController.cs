...
namespace BookStore.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        {
            var books = await _context.BookList.FindAsync(id);
        ...
        // DELETE: api/Books/5
        [HttpDelete("{id}")]
        public async Task<ActionResult<Books>> DeleteBooks(long id)
        {
            var books = await _context.BookList.FindAsync(id);
            if (books == null)
            {
            ...
            _context.BookList.Remove(books);
            await _context.SaveChangesAsync();
